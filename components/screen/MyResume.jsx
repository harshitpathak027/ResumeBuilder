      ...
      >
        ...
        <View style={{ marginBottom: 24, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 10 }}>
            ...
            {/* Touchable Avatar Photo */}
            <TouchableOpacity 
              activeOpacity={0.8}
              onPress={() => router.push('/profile')}
              style={{ width: 44, height: 44, borderRadius: 22, padding: 2.5, backgroundColor: T.green }}
            >
              {user?.avatar ? (
        ...
        {/* Resume List with inline action buttons */}
          ...
          <View style={{
            ...
            <View style={{ flex: 1 }}>
              <Text style={{ fontSize: 13.5, lineHeight: 20, fontWeight: '600', color: T.ink }}>
                You're close to a Master Rank! Finish your <Text style={{ fontWeight: '800' }}>{inProgress.title || 'Product Design'}</Text> resume to earn +200 XP.
              </Text>
