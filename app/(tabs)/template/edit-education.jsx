...
const handleAddOrUpdate = async () => {
  ...
  resume: { id: Number(resumeId) },
      ...
      isCurrent: formData.currentlyStudying,
      gpa: formData.gpa,
        ...
        {showAddForm && (
          <View className="bg-white rounded-3xl p-4 mx-4 mb-4 border border-gray-200">
            <View className="flex-row items-center justify-between mb-3">
              <Text className="text-lg font-semibold text-gray-900">New Education</Text>
...
<Switch
  ...
  onValueChange={(v) => handleChange("currentlyStudying", v)}
